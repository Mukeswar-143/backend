...
public class ProductController {
    ...
    public ResponseEntity<Page<ProductEntity>> getProducts(
        ...
        Page<ProductEntity> products = (category != null && !category.trim().isEmpty())
                ? pService.getProductsByCategory(category, pageable)
                : pService.getAllProducts(pageable);
